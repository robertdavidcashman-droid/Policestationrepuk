...
export const GETTING_STARTED_PATH = [
  ...
  { step: 4, title: 'Follow the PSRAS route', href: '/HowToBecomePoliceStationRep', desc: 'Written test → portfolio → CIT → Police Station Register.' },
  { step: 5, title: 'Build your portfolio properly', href: '/BuildPortfolioGuide', desc: 'Part A observation and Part B supervised practice.' },
  { step: 6, title: 'Prepare for the CIT', href: '/PrepareForCIT', desc: 'Scenario assessment — PACE, vulnerability, s.34, Code D.' },
  { step: 7, title: 'Find work after accreditation', href: '/GetWork', desc: 'Rota cover, directories, networking, reliability.' },
] as const;
